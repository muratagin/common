...
export const INSUREDS_DUMMY_DATA = {
  ...
  columns3: [
    ...
    {
      name: "Poliçe Başlangıç Tarihi",
      selector: "PolicyStartDate",
      key: "PolicyStartDate",
    },
    {
      name: "Poliçe Bitiş Tarihi",
...
export const INDIVIDUAL_TYPE_OPTIONS = [
  {
    value: 1,
    label: "Fert",
  },
